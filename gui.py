...
import base_classes, core, utils, workers
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def start_online_tracking(self):
        try:
            ...
            stop_icon.addPixmap(QtGui.QPixmap(utils.resource_path('resources/icons/stop.ico')))
    ...
    def stop_online_tracking(self):
        ...
        start_icon.addPixmap(QtGui.QPixmap(utils.resource_path('resources/icons/start.ico')))
    ...
    def init_ui(self):
        ...
        self.ui.spinning_img = QtGui.QMovie(utils.resource_path('resources/img/lazyloader.gif'))
    ...
    def print_worklog_table(self):
        ...
        for row_num, worklog_entry in enumerate(day_worklog):
            ...
            time_spent_item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignHCenter)
            self.ui.tableDayWorklog.setItem(row_num,
                                            4,
                                            time_spent_item)
        ...
        # restore sorting
        self.ui.tableDayWorklog.sortByColumn(2, QtCore.Qt.SortOrder.AscendingOrder)
        self.ui.tableDayWorklog.setSortingEnabled(True)
        # beautifying
        self.ui.tableDayWorklog.horizontalHeader().setSectionResizeMode(1, QtWidgets.QHeaderView.ResizeMode.Stretch)
