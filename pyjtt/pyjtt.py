...
def get_issue_from_jira(creds, issue_key):
    logging.info('Fetching issue with key "%s"' % issue_key)
...
def update_worklog(creds, issue, worklog_id,
    ...
    logging.info('Worklog for issues "%s" has been updated')