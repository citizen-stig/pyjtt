...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resource_path('icons/icon.png')))
    ...
    # this one is default   self.startStopTracking.setLayoutDirection(QtCore.Qt.AlignmentFlag.LeftToRight)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(resource_path('resources/icons/start.ico')))
        ...
        self.labelSelectedIssue.setContentsMargins(0, 0, 0, 0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionReresh_issue.setText(_translate("MainWindow", "Reload issue"))
        self.actionFull_refresh.setText(_translate("MainWindow", "Full issues reload"))
...
from widgets import pyjtt_res_rc
